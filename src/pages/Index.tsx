...
import { FadeIn, SlideUp, StaggerChildren, HoverLift, GentlePulse } from "@/components/ui/animations";
      ...
      <main className="relative z-10 px-6 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <section id="infrastructure" className="mb-16">
            <SlideUp delay={0.1}>
              <HoverLift>
                <Card className="bg-white/80 backdrop-blur-sm border-l-8 border-crystal-500 shadow-xl card-hover">
                  <CardContent className="p-8">
          ...
          <section id="self-improvement" className="mb-16">
            <SlideUp delay={0.2}>
              <HoverLift>
                <Card className="bg-white/80 backdrop-blur-sm border-l-8 border-moss-500 shadow-xl card-hover">
                  <CardContent className="p-8">
          ...
          <section id="human-connection" className="mb-16">
            <SlideUp delay={0.3}>
              <HoverLift>
                <Card className="bg-white/80 backdrop-blur-sm border-l-8 border-sunflower-500 shadow-xl card-hover">
                  <CardContent className="p-8">
          ...
          <section id="decision-frameworks" className="mb-16">
            <SlideUp delay={0.4}>
              <HoverLift>
                <Card className="bg-white/80 backdrop-blur-sm border-l-8 border-navy-500 shadow-xl card-hover">
                  <CardContent className="p-8">
          ...
          <section id="strategic-focus" className="mb-16">
            <SlideUp delay={0.5}>
              <HoverLift>
                <Card className="bg-white/80 backdrop-blur-sm border-l-8 border-rouge-500 shadow-xl card-hover">
                  <CardContent className="p-8">
          ...
          <section id="conclusion" className="mb-16">
            <FadeIn delay={0.3}>
              <HoverLift>
                <Card className="bg-gradient-to-br from-navy-900 to-navy-800 text-white border-0 shadow-xl card-hover">
                  <CardContent className="p-8">
          ...
          <section className="mb-16">
            <FadeIn delay={0.4}>
              <HoverLift>
                <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl card-hover">
                  <CardContent className="p-8">
                    ...
                    <div className="mb-6 flex justify-center">
                      <FadeIn delay={0.2}>
                        <img 
                          ...
                          className="w-40 h-40 rounded-full shadow-lg object-cover hover-lift"
                        />
                      </FadeIn>
                    </div>
          ...
          <section className="mb-16">
            <FadeIn delay={0.6}>
              <HoverLift>
                <Card className="bg-gradient-to-br from-sunflower-500 to-sunflower-600 text-white border-0 shadow-xl card-hover">
                  <CardContent className="p-8">
